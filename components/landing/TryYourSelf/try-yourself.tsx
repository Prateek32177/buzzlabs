      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          ...
          <p className="text-violet-200 max-w-2xl mx-auto">
            Experience the power of our webhook management system with this interactive demo. Follow the steps below to
            create, manage, and test webhooks in real-time.
          </p>
        </motion.div>
          ...
          <div className="flex items-center max-w-3xl w-full">
            {[1, 2, 3, 4].map((step) => (
              <div key={step} className="flex-1 flex items-center">
                ...
                {step < 4 && <div className={`h-1 flex-1 ${step < currentStep ? "bg-violet-600" : "bg-gray-700"}`} />}
              </div>
            ))}
          </div>
        </div>
