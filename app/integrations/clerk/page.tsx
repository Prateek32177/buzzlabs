...
export const metadata: Metadata = {
  title: 'Clerk Webhooks | Monitor Clerk Auth Events with Real-Time Alerts - Hookflo',
  description:
  ...
  return (
    <article className="max-w-3xl px-6 py-20 mx-auto prose prose-zinc dark:prose-invert">
      <header className="mb-10">
        <h1 className="text-4xl font-semibold">Track Clerk Webhooks with Hookflo</h1>
      ...
      <section>
        ...
        <p>
          Clerk emits webhooks when user events occur in your authentication flow — like new user signups, profile updates, or deletions.
          These events are essential for audit trails, analytics, and internal alerts.
        </p>
      </section>
      <br />
      ...
      <section>
        ...
        <ul>
          <li><code>user.created</code> — new signup</li>
          <li><code>user.deleted</code> — user deletion</li>
          <li><code>user.updated</code> — profile or metadata change</li>
          <li><code>user.verification.updated</code> — email/phone verification event</li>
        </ul>
      </section>
    <br />
      <section>
        ...
        <ul>
          <li>Instant alerting in Slack or Email when users sign up or are deleted</li>
          <li>No-code setup — just copy the webhook URL from Hookflo dashboard</li>
          <li>View webhook logs, inspect payloads, and retry failures easily</li>
          <li>Supports Clerk alongside platforms like Supabase, GitHub, and Stripe</li>
        </ul>
      </section>
    <br />
      <section>
        ...
        <ol>
          ...
          <li>Paste the URL, select the desired events (like <code>user.created</code>)</li>
          <li>Save the webhook</li>
        </ol>
      </section>
    <br />
      <section>
        <h2>Sample Webhook Payload: <code>user.created</code></h2>
        <pre>
